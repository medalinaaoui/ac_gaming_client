  ...
  return (
    <div className="min-h-[90vh] flex justify-center items-center">
      <div className="grid sm:grid-cols-4 grid-cols-2 gap-2">
        <Link to="/standings">
          <article className=" article-con aspect-square rounded-lg p-1 flex flex-col items-center justify-center">
        ...
        <Link to="/join">
          <article className="relative  article-con aspect-square rounded-lg p-1 flex flex-col items-center justify-center">
